...
WhiteBoxRenderer::WhiteBoxRenderer(Shader shader, Camera& camera)
    :camera(camera)
{
    this->shader = shader;
    this->init();
...
void WhiteBoxRenderer::Draw(glm::vec3 position, glm::vec3 size, float rotation, glm::vec3 color)
{
    this->shader.use();
